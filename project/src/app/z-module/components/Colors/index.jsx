    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="pt-8 px-16 mx-auto max-w-full lg:px-24 sm:text-center lg:pt-16">
            ...
            <div className="gap-4 mt-8 sm:grid sm:grid-cols-4 sm:mt-12">
                ...
                <img className="col-span-1 rounded-lg" src="https://zovrus.ru/files/_cache/product/dsc08929.resize1200x1200w.jpg?a273c3827b30640f85991bf1f23dc707" alt="content gallery 2"/>
                ...
                <img className="col-span-1 rounded-lg" src="https://zovrus.ru/files/_cache/product/chr-3780.resize1200x1200w.jpg?8edcdce1cd9a796b5c426d3c25905ccf" alt="content gallery 5"/>
                <img className="col-span-1 rounded-lg" src="https://zovrus.ru/files/_cache/product/chr-5650.resize1200x1200w.jpg?99512fcbd6b465ce180887a22497881a" alt="content gallery 6"/>
                <img className="col-span-1 rounded-lg" src="https://zovrus.ru/files/_cache/product/chr-2152.resize1200x1200w.jpg?f3b82632ecac9231dab2f9442233cec9" alt="content gallery 6"/>
                <img className="col-span-1 rounded-lg" src="https://zovrus.ru/files/_cache/product/chr-8945.resize800x800w.jpg?d1734f6452cf2d662162fce1a1ea377f" alt="content gallery 6"/>
            </div>
        </div>
    </section>
  )
