      ...
      <nav className="mx-auto flex max-w-full items-center justify-between p-4 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <div className="lg:flex lg:min-w-0 lg:flex-1 lg:justify-end">
            <div className="bg-white flex rounded-lg px-4 py-1 text-xl font-semibold leading-6  shadow-lg shadow-gray-300/10 bg-gradient-to-r from-gray-50/50 via-gray-50/50 to-gray-100/50 ring-offset-2 ring-1 ring-gray-200">
