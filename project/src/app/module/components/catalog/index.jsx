      ...
      <div className="mx-auto max-w-full px-6 lg:px-8">
        <div className="-mx-6 grid grid-cols-2 gap-0.5 overflow-hidden sm:mx-0 sm:rounded-2xl md:grid-cols-6 ">
          <div className="bg-slate-900 p-3 sm:p-5">
            <Image
              className="max-h-10 w-full text-red-700 object-contain transition ease-in-out hover:scale-110"
          ...
          <div className="bg-slate-900 p-3 sm:p-5">
            <Image
              className="max-h-10 w-full object-contain transition ease-in-out hover:scale-110"
              src="https://zovrus.ru/design/zovrus/images/menu/icon2.svg"
              alt="Transistor"
              width={158}
              height={48}
          ...
          <div className="bg-slate-900 p-3 sm:p-5">
            <Image
              ...
              height={48}
            />
            <p className="text-gray-50 text-center pt-2">Мебель для ванной</p>
          </div>
          <div className="bg-slate-900 p-3 sm:p-5">
            <Image
              className="max-h-10 w-full object-contain transition ease-in-out hover:scale-110"
          ...
          <div className="bg-slate-900 p-3 sm:p-5">
            <Image
              ...
              height={48}
            />
            <p className="text-gray-50 text-center pt-2">Распродажа</p>
          </div>
        </div>
      </div>
    </div>
