            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <div className="mt-10 max-w-xl text-base leading-7 text-gray-700">
                  ...
                  <p className="mt-10">
                    Мы уделяем особое внимание каждой детали нашей продукции, от выбора материалов до конечного производства. Мы тщательно подбираем только самые лучшие материалы, такие как натуральное дерево, металл и стекло, чтобы наша мебель была долговечной и выглядела прекрасно на протяжении многих лет.
                  </p>
                  <p className="mt-10">
